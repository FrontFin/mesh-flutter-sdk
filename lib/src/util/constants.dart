...
const _externallyOpenedOrigins = [
  ...
  'https://metamask.app.link',      // MetaMask (WalletConnect universal link)
  'https://link.metamask.io',       // MetaMask (in-wallet browser)
  'https://phantom.app',            // Phantom
  'https://base.app',               // Base (Coinbase Wallet)
  'https://bkcode.vip',             // Bitget Wallet
  'https://app.tonkeeper.com',      // Tonkeeper
